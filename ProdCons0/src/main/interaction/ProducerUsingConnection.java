			...
			public void run() {
				try {
					...
					CommUtils.outmagenta(
							pfx + name + " SENDING request synch " + req + " " + Thread.currentThread().getName());
					...
					CommUtils.outgreen(
							pfx + name + " SENDING request asynch " + req + " " + Thread.currentThread().getName());
					conn.forward(req);
					// INVIO DISPATCH
					CommUtils
							.outgreen(pfx + name + " SENDING dispatch " + msg + " " + Thread.currentThread().getName());
					conn.forward(msg);
