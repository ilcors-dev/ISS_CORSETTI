...
public class MainEnablersProducersOnly {
    ...
    public void configureTheSystem() {
        ...
        ProducerUsingConnection producer1 = new ProducerUsingConnection("corsettiluca", host, port, protocol);
        // ProducerUsingConnection producer2 = new ProducerUsingConnection("prod2",
        // host, port, protocol);
