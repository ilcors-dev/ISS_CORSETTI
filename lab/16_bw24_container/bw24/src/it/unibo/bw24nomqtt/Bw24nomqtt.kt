...
class Bw24nomqtt ( name: String, scope: CoroutineScope, isconfined: Boolean=false  ) : ActorBasicFsm( name, scope, confined=isconfined ){
	...
	override fun getBody() : (ActorBasicFsm.() -> Unit){
		...
		return { //this:ActionBasciFsm
				...
				state("handleWolf") { //this:State
					action { //it:State
						CommUtils.outmagenta("$name wolf detected, stop!")
						delay(1000) 
						//genTimer( actor, state )
					}
					//After Lenzi Aug2002
					...
					transition(edgeName="t07",targetState="handleWolf",cond=whenEvent("wolf"))
				}	 
				...
				state("handleSonardata") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t08",targetState="doboundary",cond=whenDispatch("stepdone"))
					transition(edgeName="t09",targetState="turnAndgo",cond=whenDispatch("stepfailed"))
				}	 
			}
		}
} 
