...
public class VrobotLLMoves24 extends ApplAbstractObserver implements IVrobotLLMoves {
    ...
    public void backward(int time) throws Exception {
        ...
        requestSynch(VrobotMsgs.backwardcmd.replace("TIME", "" + time));
        CommUtils.outred("backward done");
    }
    ...
    protected void handleMoveok(String move) {
        ...
        if ((move.equals("turnLeft") || move.equals("turnRight")) || move.equals("moveBackward")) {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // VrobotLLMoves24 appl = VrobotLLMoves24.create("localhost",null); //new
        // VrobotLLMoves24("localhost",null);
        // appl.move("a");
        // appl.move("d");
        // CommUtils.delay(500);
        // appl.move("w");
