	...
	override fun getBody() : (ActorBasicFsm.() -> Unit){
		...
		return { //this:ActionBasciFsm
				...
				state("coverColumn") { //this:State
					...
					interrupthandle(edgeName="t02",targetState="doPause",cond=whenEvent("pause"),interruptedStateTransitions)
				}	 
				state("doPause") { //this:State
					action { //it:State
						CommUtils.outred("$name | pause")
						delay(2000) 
				...
				state("turn") { //this:State
					...
					interrupthandle(edgeName="t05",targetState="doPause",cond=whenEvent("pause"),interruptedStateTransitions)
				}	 
				...
				state("coverLastColumn") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t010",targetState="coverLastColumn",cond=whenDispatch("stepdone"))
					transition(edgeName="t011",targetState="endofwork",cond=whenDispatch("stepfail"))
				}	 
