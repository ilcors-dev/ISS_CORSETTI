...
### see https://renenyffenegger.ch/notes/tools/Graphviz/attributes/label/HTML-like/index
     ...
     sys >> Edge( label='sonardata', **evattr, decorate='true', fontcolor='darkgreen') >> boundary
     ...
     boundary >> Edge(color='blue', style='solid',  decorate='true', label='<setdirection &nbsp; cmd &nbsp; >',  fontcolor='blue') >> basicrobot
diag
