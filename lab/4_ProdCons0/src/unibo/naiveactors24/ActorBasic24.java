...
public abstract class ActorBasic24 implements IActor24 {
    ...
    protected void mainLoop() {
        try {
            ...
            while (true) {
                ...
                CommUtils.outyellow(
                        "		" + name + "| mainLoop takes:" + msg + " thname=" + Thread.currentThread().getName());
    ...
    protected void sendMsg(IApplMessage msg, ActorContext24 ctx) {
        try {
            ...
            // CommUtils.outcyan( " ActorBasic24 | sendMsg " + msg + " to " + destActorName
    ...
    protected void sendReply(IApplMessage request, IApplMessage reply) {
        // CommUtils.outmagenta( name + " | sendReply with Alien conn= " +
        // request.getConn() );
